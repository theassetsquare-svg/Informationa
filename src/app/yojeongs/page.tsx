...
export const metadata: Metadata = {
  title: '요정 문화의 정수 — 한정식과 국악이 어우러지는 자리', description: cat.description,
  alternates: { canonical: SITE_URL + '/yojeongs/' },
  openGraph: { title: '요정 문화의 정수 — 한정식과 국악이 어우러지는 자리', description: cat.description, url: SITE_URL + '/yojeongs/', siteName: SITE_NAME, locale: 'ko_KR', type: 'website', images: [{ url: SITE_URL + '/og/yojeongs.png', width: 1200, height: 1200 }] },
};
