...
export const metadata: Metadata = {
  title: '나이트 58곳 솔직 정리 — 테이블 잡기 전에 읽어라', description: cat.description,
  alternates: { canonical: SITE_URL + '/nights/' },
  openGraph: { title: '나이트 58곳 솔직 정리 — 테이블 잡기 전에 읽어라', description: cat.description, url: SITE_URL + '/nights/', siteName: SITE_NAME, locale: 'ko_KR', type: 'website', images: [{ url: SITE_URL + '/og/nights.png', width: 1200, height: 1200 }] },
};
